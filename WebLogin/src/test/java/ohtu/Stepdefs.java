...
public class Stepdefs {
    ...
    public void register_new_user_is_selected() throws Throwable {
        driver.get(baseUrl);
    ...
    @When("^a valid username \"([^\"]*)\" and valid password \"([^\"]*)\" and mismatching password confirmation are entered$")
    public void a_valid_username_and_valid_password_and_mismatching_password_confirmation_are_entered(String username, String password) throws Throwable {
        registerWith(username, password, password + "morjens");
    }
    ...
    public void user_with_username_with_password_is_successfully_created(String username, String password) throws Throwable {
        register_new_user_is_selected();
        registerWith(username, password, password);
        returnToMainFromRegister();
    }
    ...
    public void user_with_username_and_password_is_tried_to_be_created(String username, String password) throws Throwable {
        register_new_user_is_selected();
        registerWith(username, password, password);
        returnToMainFromFailedRegister();
    }
...
//        try{ Thread.sleep(120000); } catch(Exception e){}
    ...
    private void returnToMainFromRegister() {
    ...
    private void returnToMainFromFailedRegister() {
